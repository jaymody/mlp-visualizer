...
seed = 2 # Seed for the generated data (used 422 for git repo)

n_features = 2 # number of input variables (must be  2 for accurate plotting in matplotlib)
l1 = 64 # first hidden layer nodes
l2 = 64 # second hidden layer nodes
l3 = 32 # third hidden layer nodes
...
cluster_std = 0.5 # the standard deviation of the data points from the center of the blob clusters
...
n_epochs = 32 # number of training iterations on the training set
...
points_per_int = 3 # num of points in an int (frequency of points in area map)
